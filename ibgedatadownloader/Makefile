...
SOURCES = \
	__init__.py \
	ibgeDataDownloader.py ibgeDataDownloader_dialog.py

PLUGINNAME = ibgeDataDownloader

PY_FILES = \
	__init__.py \
	ibgeDataDownloader.py ibgeDataDownloader_dialog.py

UI_FILES = ibgeDataDownloader_dialog_base.ui
...
QGISDIR=C:\Users\Vinic\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
